...
def save_results(model_name, device, metadata, vendor_datasets_3D, show_example=False):
    ...
    results = results.assign(
        Dice_BG_ED=None, Dice_LV_ED=None, Dice_MYO_ED=None, Dice_RV_ED=None
    )
    results = results.assign(
        Dice_BG_ES=None, Dice_LV_ES=None, Dice_MYO_ES=None, Dice_RV_ES=None
    )

    results = results.assign(
        IoU_BG_ED=None, IoU_LV_ED=None, IoU_MYO_ED=None, IoU_RV_ED=None
    )
    results = results.assign(
        IoU_BG_ES=None, IoU_LV_ES=None, IoU_MYO_ES=None, IoU_RV_ES=None
    )
